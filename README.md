...
Look at the [demo pipeline](https://github.com/Aptomi/concourse-email-resource/blob/master/example/demo-pipeline.yml) for a complete example.
...
* Clone the repo:
  ...
  - `git clone git@github.com:Aptomi/concourse-email-resource.git`
